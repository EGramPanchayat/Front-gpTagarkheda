        ...
        <div className="max-w-8xl w-full flex flex-col items-center">
          ...
          <div className="bg-white  rounded-xl shadow-lg p-4 sm:p-8 mb-4 sm:mb-8 hover:shadow-2xl hover:-translate-y-1 transition">
            ...
            <p className="text-lg text-justify leading-relaxed">
              तगरखेडा हे <span className="text-orange-500 font-semibold">महाराष्ट्र राज्यातील लातूर जिल्ह्यातील निलंगा तालुक्यातील</span> मांजरा व तेरणा या नद्यांच्या संगमावर वसलेले एक प्रगतशील गाव आहे. २०११ च्या जनगणनेनुसार या गावाची लोकसंख्या सुमारे <span className="text-orange-500 font-semibold">3711</span> आहे.
